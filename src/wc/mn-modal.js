/**
 * <mn-modal> — Web Component wrapper for Maranello modal dialog
 * Shadow DOM modal with focus-trap, Escape close, backdrop click close.
 *
 * @attr {boolean} open  - Shows/hides the modal
 * @attr {string}  title - Modal header title
 * @fires mn-close - Dispatched when the modal is closed
 * @version 1.4.0
 */
