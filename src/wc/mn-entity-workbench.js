...
class MnEntityWorkbench extends HTMLElement {
  ...
  set schema(value) { this._schema = value?.tabs ? value : { tabs: [] }; if (this.isConnected && this.hasAttribute('open')) this._mount(); }
  get data() { return this._data; }
  set data(value) { this._data = value && typeof value === 'object' ? value : {}; if (this.isConnected && this.hasAttribute('open')) this._mount(); }
  get editable() { return this._editable; }
  set editable(value) { this._editable = Boolean(value); if (this.isConnected && this.hasAttribute('open')) this._mount(); }
  get actions() { return this._actions; }
  set actions(value) { this._actions = Array.isArray(value) ? value : []; if (this.isConnected && this.hasAttribute('open')) this._mount(); }
