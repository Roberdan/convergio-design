/**
 * <mn-async-select> — Web Component wrapper for AsyncSelect headless control.
 *
 * @attr {string} placeholder - Input placeholder text
 * @attr {number} min-chars   - Minimum chars before search
 * @attr {number} debounce    - Debounce delay in ms
