...
const GROUPS = [
  ...
  { title: 'Controls', items: [
    ...
    { tag: 'mn-theme-toggle', desc: 'Cycles the four demo themes with a compact branded switch.', preview: `<mn-theme-toggle></mn-theme-toggle>` },
    ...
    { tag: 'mn-a11y', desc: 'Floating accessibility hub for contrast, motion, and focus settings.', preview: `<div style="display:flex;flex-direction:column;align-items:center;gap:8px"><div style="width:48px;height:48px;border-radius:50%;background:var(--mn-accent);display:grid;place-items:center;box-shadow:0 2px 8px rgba(0,0,0,.3);cursor:default" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#111" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/></svg></div><span class="mn-micro" style="color:var(--mn-text-muted)">Accessibility FAB (auto-mounted)</span></div>` },
    { tag: 'mn-theme-rotary', desc: 'Cockpit-grade theme selector dial with 4 positions — Editorial, Nero, Avorio, Colorblind.', preview: `<mn-theme-rotary size="100"></mn-theme-rotary>` },
  ] },
  { title: 'Data', items: [
  ...
  { title: 'Layout', items: [
    ...
    { tag: 'mn-section-nav', desc: 'Paginated section navigator with prev/next arrows and position indicator.', preview: `<mn-section-nav sections='["Overview","Details","Settings"]' current="1"></mn-section-nav>` },
  ] },
